...
if R>0 and R<8:#проверка на радиус
    figu = plt.figure()
    ax = plt.axes()
    ...
    ax.set(xlim=(-5, 20), ylim=(-10, 15))  #: устанавливает ограничения для осей x и y, чтобы значения на графике были видны в заданных пределах.5
    ...
    ax.xaxis.set_major_locator(plt.MultipleLocator(2))  # устанавливает основной локатор на оси X, который размещает маркеры на основе заданного интервала, маркеры будут размещены каждые 2 единицы на оси X.
